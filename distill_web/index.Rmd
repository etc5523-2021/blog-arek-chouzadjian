...
2. How the Death Rate from COVID-19 in Panama has fluctuated from month to month, and the implications that measure has for health system capability, and vaccine coverage/efficacy. 
...
The summary statistics table shows that the mean number of cases per month during the COVID-19 pandemic in Panama is just over 25,000, and the mean number of deaths per month is around 390. The mean Death Rate per month during the pandemic is around 1.7%. 
...
Levin AT, Hanage WP, Owusu-Boaitey N, et al. Assessing the age specificity of infection fatality rates for COVID-19: Systematic review, meta-analysis, and public policy implications. Euro J Epidemiol. 2020;35(12):1123–1135.
